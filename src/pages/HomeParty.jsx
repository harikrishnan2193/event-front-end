...
function HomeParty() {
  return (
    <>
      <div className="row bg3-img">
        <h2 className='text-center text-light fw-bolder' style={{marginTop:'200px',marginBottom:'150px'}}><span style={{color:'green'}}>Make The</span> <span style={{color:'red'}}>Event With Us</span></h2>
      </div>
      <div className="row">
        <div className="row">
